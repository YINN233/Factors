...
- 输出目录：`outputs/fundamental_operator_mining_csi500_smoke_fast`
- 全部拆分汇总：`outputs/fundamental_operator_mining_csi500_smoke_fast/all_split_summary.csv`
- 稳定性表：`outputs/fundamental_operator_mining_csi500_smoke_fast/stable_factors.csv`
- 最终推荐：`outputs/fundamental_operator_mining_csi500_smoke_fast/selected_factors.csv`
- 本报告：`docs/fundamental_operator_mining_csi500_smoke_fast_2026-07-15.md`