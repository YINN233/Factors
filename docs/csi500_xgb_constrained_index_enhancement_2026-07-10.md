...
- 当前公开因子筛选后进入模型候选的公开特征数为 37 个；不加风格约束的 XGB 方案在 2025-01-02 至 2026-07-03 测试期超额为 -0.08%，IR 为 -0.14，说明外源公开因子直接进组合仍不稳。
- 加行业/风格约束后，`xgb_industry_style_tight` 是测试期最稳的 XGB 约束方案；测试期超额约 3.39%，IR 约 2.62，主动最大回撤约 -0.54%。
...
| xgb_no_style_constraint | full | 31.65% | 1.46% | 2.24 | -2.44% | 56.91% | 72.82% | 19.02% | 0.45% |
| xgb_no_style_constraint | test | -0.08% | 1.76% | -0.14 | -1.97% | 48.62% | 52.63% | 18.77% | 0.50% |
| xgb_no_style_constraint | ytd_2026 | 0.09% | 1.96% | -0.00 | -0.82% | 51.26% | 57.14% | 18.44% | 0.61% |
| xgb_industry_style_tight | full | 18.82% | 0.82% | 2.60 | -1.00% | 56.81% | 71.84% | 12.53% | 0.39% |
| xgb_industry_style_tight | test | 3.39% | 0.89% | 2.62 | -0.54% | 55.25% | 73.68% | 12.44% | 0.48% |
| xgb_industry_style_tight | ytd_2026 | 2.57% | 1.22% | 4.44 | -0.36% | 57.14% | 85.71% | 12.45% | 0.62% |
| xgb_industry_style_mid | full | 24.88% | 0.95% | 2.89 | -1.13% | 57.65% | 75.73% | 17.53% | 0.42% |
| xgb_industry_style_mid | test | 3.51% | 0.95% | 2.52 | -0.49% | 56.35% | 78.95% | 17.39% | 0.50% |
| xgb_industry_style_mid | ytd_2026 | 2.51% | 1.28% | 4.10 | -0.49% | 59.66% | 85.71% | 17.10% | 0.62% |
| xgb_industry_style_loose | full | 31.60% | 1.12% | 3.03 | -1.20% | 58.04% | 79.61% | 22.65% | 0.52% |
| xgb_industry_style_loose | test | 3.44% | 1.05% | 2.21 | -0.65% | 54.97% | 78.95% | 22.47% | 0.57% |
| xgb_industry_style_loose | ytd_2026 | 2.31% | 1.39% | 3.45 | -0.65% | 60.50% | 85.71% | 21.88% | 0.67% |
...
| --- | --- | --- | --- | --- | --- |
| 2026-01 | -0.06% | 0.20% | 0.18% | 0.16% | 0.05% |
| 2026-02 | 0.25% | -0.23% | -0.15% | -0.11% | -0.35% |
| 2026-03 | 0.24% | 0.39% | 0.26% | 0.14% | 0.55% |
| 2026-04 | 0.31% | 0.24% | 0.31% | 0.32% | -0.66% |
| 2026-05 | 1.19% | 0.81% | 0.80% | 0.77% | 0.92% |
| 2026-06 | 1.28% | 0.75% | 0.97% | 1.13% | -0.55% |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| train | 0.1525783416394414 | 1.2828465502926896 | 0.9120603015075376 | 0.1687087955680869 | 1194.0 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| valid |  |  |  |  |  | 0.065458323010498 | 0.4533644060232097 | 0.6797520661157025 | 0.0830144995444433 | 484.0 |  |  |  |  |  |  |  |  |  |  |
| test |  |  |  |  |  |  |  |  |  |  | 0.0599240556015949 | 0.3546773127869834 | 0.6218487394957983 | 0.0673326559572574 | 357.0 |  |  |  |  |  |
| ytd_2026 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | 0.0381214685331061 | 0.2327010656694156 | 0.5526315789473685 | 0.0394412643265517 | 114.0 |

| feature | importance | importance_type |
| --- | --- | --- |
| rl2_54_turnover_volatility_inverse | 0.7047 | prediction_corr |
| rl2_62_reversal_turnover_boost | 0.6918 | prediction_corr |
| rl_03_pvt_covariance_reversal | 0.6427 | prediction_corr |
| rl2_65_turnover_volatility_momentum | 0.6420 | prediction_corr |
| rl2_51_multidim_reversal | 0.6173 | prediction_corr |
| rl_22_volume_divergence_momentum | 0.5390 | prediction_corr |
| rl2_50_price_volume_volatility_inverse | 0.5209 | prediction_corr |
| rl_06_vol_compression_momentum | 0.4934 | prediction_corr |
| rl2_52_main_flow_peak_inverse | 0.4739 | prediction_corr |
| rl2_53_main_flow_stability | 0.4714 | prediction_corr |
| rl2_57_vol_adjusted_reversal | 0.4581 | prediction_corr |
| rl_23_turnover_relative_reversal | 0.4570 | prediction_corr |
| rl_16_decay_volume_trend | 0.4076 | prediction_corr |
| rl2_27_reverse_price_volume_rank | 0.3968 | prediction_corr |
...
4. 当前模型后端是 sklearn fallback，不是原生 xgboost gain；特征重要性采用 `prediction_corr`，只能看作贡献线索。
